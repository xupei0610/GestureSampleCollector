...
SettingsView *SettingsView::getInstance()
{
    return Singleton<SettingsView>::instance(SettingsView::createInstance);
}

SettingsView *SettingsView::createInstance()
{
...
void SettingsView::setToCurrentSettings()
{
    blockSignals(true);
...
void SettingsView::setToDefaultSettings()
{
    blockSignals(true);
...
void SettingsView::activatePage(const SettingsView::SETTINGS_VIEW_PAGE &page)
{
    _ui_tab_widget->setCurrentIndex(static_cast<int>(page));
}

void SettingsView::syncSettings()
{
    if (_flag_change_hue)
    {
...
void SettingsView::_uiSldHue1ValueChanged(const int &val)
{
...
void SettingsView::_uiSldHue2ValueChanged(const int &val)
{
    _flag_change_hue = true;
...
void SettingsView::_uiSldSaturation1ValueChanged(const int &val)
{
...
void SettingsView::_uiSldSaturation2ValueChanged(const int &val)
{
    _flag_change_saturation = true;
...
void SettingsView::_uiSldValue1ValueChanged(const int &val)
{
...
void SettingsView::_uiSldValue2ValueChanged(const int &val)
{
    _flag_change_value = true;
...
void SettingsView::_uiSldHorizon1ValueChanged(const int &val)
{
...
void SettingsView::_uiSldHorizon2ValueChanged(const int &val)
{
    _flag_change_roi_x = true;
...
void SettingsView::_uiSldVertical1ValueChanged(const int &val)
{
...
void SettingsView::_uiSldVertical2ValueChanged(const int &val)
{
    _flag_change_roi_y = true;
...
void SettingsView::_uiBoxDetectionAreaValueChanged(const int &val)
{
    _flag_change_detection_area = true;
    emit changeDetectionArea(val);
}

void SettingsView::_uiBoxMorphologyToggled(const bool &checked)
{
    _flag_change_morphology = true;
    emit changeMorphology(checked);
}

void SettingsView::_emitSkinColorRangeChangeSignal()
{
...
void SettingsView::_emitRoiRangeChangeSignal()
{
...
void SettingsView::_backgroundSettingRequest()
{
    _ui_btn_bg_clear->setEnabled(false);
    emit backgroundSettingRequest();
}

void SettingsView::_backgroundClearingRequest()
{
    _ui_btn_bg_clear->setEnabled(false);
    emit backgroundClearingRequest();
}

void SettingsView::enableBackgroundSetting()
{
    _ui_btn_bg_set->setEnabled(true);
}

void SettingsView::disableBackgroundSetting()
{
    _ui_btn_bg_set->setEnabled(false);
}

void SettingsView::setBackgroundImage(const QPixmap &img)
{
...
void SettingsView::clearBackgroundImage()
{
    _ui_lbl_background->clear();
}

void SettingsView::_gestureListAdd()
{
    bool ok;
...
void SettingsView::_gestureListRemove()
{
...
void SettingsView::_gestureEdit(QListWidgetItem *item)
{
    bool ok;
...
void SettingsView::_makeConnections()
{
