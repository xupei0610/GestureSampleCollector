 ...
 * @brief The SettingsView.hpp file contains a singleton class that provides the GUI of the setting window.
 */
...
/**
 *@brief The SettingsView class provides the GUI of the setting dialog.
 *
 * The setting window provides options to change most parameters of the system.\n
 * This is a singleton class. Use #SettingsView::getInstance() to get the instance of this class.
 */
...
public:
    /**
     * @brief SETTINGS_VIEW_PAGE is the index of the tab page of the setting window.
     *
     * @see #SettingsView::activatePage
     */
    enum SETTINGS_VIEW_PAGE
    {
     ...
     * @return the singleton instance of #SettingsView class
     *
     * @see #Singleton
     */
    static SettingsView *getInstance();

    /**
     * @brief activatePage sets the current default page of the setting window.
     * @param page : the default page to display
     *
     * @see #SettingsView::SETTINGS_VIEW_PAGE
     */
    void activatePage(const SETTINGS_VIEW_PAGE &page);
    /**
...
signals:
     ...
     * @see #SettingsView::changeSkinColorUpperBound
     */
     ...
     * @see #SettingsView::changeSkinColorLowerBound
     */
...
private:
    ...
    static SettingsView *createInstance();
