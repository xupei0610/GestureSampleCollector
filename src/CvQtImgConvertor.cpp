...
cv::Mat CvQtImgConvertor::qImage2CvMat(const QImage &input_image)
{
    ...
    // qWarning() << "CvQtImgConvertor() -- Unsupported QImage Input Format:" << input_image.format();
    return cv::Mat();
}

QImage CvQtImgConvertor::cvMat2QImage(const cv::Mat& input_mat)
{
